    ...
    <section id="join" className="relative isolate py-24">
      ...
      <div className="mx-auto max-w-4xl px-6">
        <Reveal y={40} duration={0.8}>
          <div className="relative overflow-hidden rounded-[2.5rem] border border-slate-200/70 bg-white p-12 text-center shadow-[0_24px_60px_-30px_rgba(15,23,42,0.28)]">
