          ...
          {items.length === 0 ? (
            ...
            <RevealList interval={0.1}>
              {items.map((item) => (
                <figure
                  key={item._id}
                  className="group overflow-hidden rounded-3xl border border-slate-200/70 bg-white shadow-[0_20px_44px_-28px_rgba(15,23,42,0.18)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_32px_64px_-32px_rgba(15,23,42,0.25)]"
                >
