...
const roleKeyOptions = [
  ...
  { value: "chairperson", label: "Chair" },
  { value: "vice-chairperson", label: "Vice Chair" },
  { value: "general-secretary", label: "Secretary" },
  { value: "joint-general-secretary", label: "Joint Secretary" },
